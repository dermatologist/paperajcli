...
export function processLatex(content: string): string {
    ...
    for (let line of lines) {
        ...
        if (line.startsWith(String.raw`\caption{image}`) || line.startsWith(String.raw`\caption{Diagram Description automatically generated}`)) {
